...
L041:
  ...
  CMP DWORD [EDX],0x80000003
  JNZ L062
  CMP DWORD [EBP-0xC], 0x0400000
  JNZ L062
  CMP DWORD [esi + nNestingLevel],0x0
  JLE L056
  MOV EAX,DWORD [esi + nNestingLevel]
  SUB EAX,0x1
  MOV DWORD [esi + nNestingLevel],EAX
L056:
  MOV ECX,DWORD [EBP+0x8]
  MOV EDX,DWORD [ECX+0xC]
  MOV EAX,DWORD [esi + nNestingLevel]
  MOV ECX,DWORD [EAX*0x4+esi + dwOpcodeBackup]
  MOV DWORD [EDX],ECX
  JMP L187
L062:
  MOV EDX,DWORD [EBP+0x8]
  ...
  MOV EDX,DWORD [ECX]
  MOV DWORD [EAX*0x4+esi + dwOpcodeBackup],EDX
  MOV EAX,DWORD [EBP-0x2C]
  MOV BYTE [EAX],0xCC
  CMP DWORD [esi + nNestingLevel],0x28
  JGE L082
  MOV ECX,DWORD [esi + nNestingLevel]
  ADD ECX,0x1
  MOV DWORD [esi + nNestingLevel],ECX
L082:
  MOV EDX,DWORD [EBP+0x10]
  MOV DWORD [EDX+0xC0],0x0
  XOR EAX,EAX
  JMP L188
L086:
  MOV EAX,DWORD [EBP+0x10]
  ...
  MOV EDX,DWORD [esi + nNestingLevel]
  MOV EAX,DWORD [EBP-0x30]
  MOV ECX,DWORD [EAX]
  MOV DWORD [EDX*0x4+esi + dwOpcodeBackup],ECX
...
L158:
  MOV EAX,DWORD [EBP+0x10]
  MOV ECX,DWORD [EAX+0xB8]
  MOV DWORD [esi + dwPrevInstructionAddr],ECX
  LEA EDX, [EBP-0x1C] ; -- REMOVE DWORD REFERENCE
  PUSH EDX
  CALL LDEX86
  ADD ESP,0x4
  MOV DWORD [EBP-0x20],EAX
